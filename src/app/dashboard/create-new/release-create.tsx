          ...
          <table className="min-w-full divide-y divide-gray-700 mb-4">
            <thead className="bg-[#1D2229]">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Artist Name</th>
            ...
            <tbody className="bg-[#1A1E24] divide-y divide-gray-700">
              {tracks.map((track) => (
                <tr key={track.id}>
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-300">{track.title}</td>
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-300">{track.artistName}</td>
