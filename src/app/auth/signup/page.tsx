...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0F1215] flex items-center justify-center font-poppins">
      <div className="w-[1720px] h-auto lg:h-[600px] mt-[40px] mx-4 lg:mx-[100px] flex flex-col lg:flex-row shadow-2xl overflow-hidden rounded-xl">
        {/* Left Section - Purple background with message - 40% width */}
        <div className="w-full lg:w-2/5 bg-[#683BAB] text-white p-8 lg:p-[60px] flex flex-col justify-between relative overflow-hidden">
          <div className="max-w-md">
            <h1 className="text-4xl lg:text-5xl font-normal -tracking-[0.05em] mb-4">Join our Music <br /> Distribution Platform</h1>
          ...
          <div className="max-w-md">
            ...
            <div className="flex mb-4">
              {[1, 2, 3, 4, 5].map((star) => (
                <svg key={star} className="w-6 h-6 text-yellow-400 mr-1" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="flex items-center">
              <div className="w-12 h-12 rounded-full bg-purple-800 mr-4 overflow-hidden">
        ...
        <div className="w-full lg:w-3/5 bg-[#161A1F] flex items-center justify-center p-8 lg:p-[60px]">
            ...
            <form onSubmit={handleSignup} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute left-[45px] top-[14px] bottom-[14px] w-[1px] bg-gray-700"></div>
                  <input
                    type="text"
                    id="fullName"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    <svg className="h-5 w-5 text-gray-500 hover:text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                      {showPassword ? (
                ...
                <p className="mt-2 text-xs text-gray-500">Password must be at least 8 characters and include a number</p>
              </div>
              ...
              <button
                type="submit"
                className="w-full flex justify-center h-[50px] items-center rounded-md shadow-sm text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-purple-500 mt-6 transition-colors"
                disabled={isLoading}
              >
                {isLoading ? (
                  <div className="flex items-center">
              ...
              <p className="mt-4 text-xs text-center text-gray-500">
                ...
                <Link href="/terms" className="ml-1 font-medium text-purple-500 hover:text-purple-400">Terms of Service</Link>
                <span className="mx-1">and</span>
                <Link href="/privacy" className="font-medium text-purple-500 hover:text-purple-400">Privacy Policy</Link>
              </p>
            </form>
