      ...
      <div className="w-[1720px] h-auto lg:h-[600px] mt-[40px] mx-4 lg:mx-[100px] flex flex-col lg:flex-row shadow-2xl overflow-hidden rounded-xl">
        ...
        <div className="w-full lg:w-2/5 bg-[#683BAB] text-white p-8 lg:p-[60px] flex flex-col justify-between relative overflow-hidden">
          <div className="max-w-md">
            <h1 className="text-4xl lg:text-5xl font-normal -tracking-[0.05em] mb-4">
        ...
        <div className="w-full lg:w-3/5 bg-[#161A1F] flex items-center justify-center p-8 lg:p-[60px]">
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full cursor-pointer flex justify-center h-[50px] items-center rounded-md shadow-sm text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-purple-500 mt-6 transition-colors"
                disabled={isLoading}
              >
                {isLoading ? (
                  <div className="flex items-center">
