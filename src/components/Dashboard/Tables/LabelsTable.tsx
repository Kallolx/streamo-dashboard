...
const mockLabels = [
  { id: 1, title: 'Midnight Drive', labelId: 'L00123', creationDate: '31/01/2025' },
  { id: 2, title: 'Midnight Drive', labelId: 'L00123', creationDate: '31/01/2025' },
  { id: 3, title: 'Midnight Drive', labelId: 'L00123', creationDate: '31/01/2025' },
  { id: 4, title: 'Midnight Drive', labelId: 'L00123', creationDate: '31/01/2025' },
  { id: 5, title: 'Midnight Drive', labelId: 'L00123', creationDate: '31/01/2025' },
  { id: 6, title: 'Midnight Drive', labelId: 'L00123', creationDate: '31/01/2025' },
  { id: 7, title: 'Midnight Drive', labelId: 'L00123', creationDate: '31/01/2025' },
  { id: 8, title: 'Midnight Drive', labelId: 'L00123', creationDate: '31/01/2025' },
  { id: 9, title: 'Midnight Drive', labelId: 'L00123', creationDate: '31/01/2025' },
  { id: 10, title: 'Midnight Drive', labelId: 'L00123', creationDate: '31/01/2025' },
];
        ...
        <table className="min-w-full divide-y divide-gray-700">
          ...
          <tbody className="bg-[#161A1F] divide-y divide-gray-700">
            {currentLabels.map((label) => (
              <tr key={label.id} className="hover:bg-[#1A1E24]">
                ...
                <td className="px-4 py-3 whitespace-nowrap">
                  <Link 
                    href={`/dashboard/catalogue/labels/${label.id}`} 
